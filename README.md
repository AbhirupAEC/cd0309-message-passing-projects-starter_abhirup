...
Run the following script to delete newly created person
`sh scripts/delete_person.sh <POD_NAME>`
...
Then once the service is running in kubernetes you can run `python modules\personlist\udaconnect\personlist_requester.py`
